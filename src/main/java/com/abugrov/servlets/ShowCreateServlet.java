...
public class ShowCreateServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	    ...
	    RequestDispatcher dispatcher = req.getRequestDispatcher("/views/show/ShowCreate.jsp");
	    dispatcher.forward(req, resp);
    }

    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	this.SHOW_STORAGE.add(new Show(this.ids.incrementAndGet(), req.getParameter("name"), req.getParameter("datetime"), req.getParameter("type"), req.getParameter("place"), req.getParameter("description")));
